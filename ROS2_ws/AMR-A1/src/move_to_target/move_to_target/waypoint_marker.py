...
class WaypointMarkerNode(Node):
    def __init__(self):
        ...
        # 기본 YAML 경로
        default_path = '/home/lim/pinky_pro/move_to_target/config/my_map_waypoints.yaml'

        # 파라미터 선언 (기본값 = default_path  변수)
        ...
        self.get_logger().info(
            f"✅ Loaded {len(self.waypoints)} waypoints from: {yaml_path}"
        )
